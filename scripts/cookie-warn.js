(function(fn) {
    ...
    var getAttributes = function() {
        ...
        if (!langData) {
            data = {
                'text': 'Ez az oldal sütiket használ annak érdekében, hogy minél személyre szabottabb és reszponzívabb élményt tudjon biztosítani.',
                'accept_text': 'Elfogadom',
                'more_text': 'Bővebben',
                'more_link': 'http://ec.europa.eu/ipg/basics/legal/cookies/index_en.htm',
                'reject_text': 'Elutasítom',
                'reject_info': 'A program segítségével letilthatja a nem kívánt sütiket',
    ...
    var warn = function() {
        ...
        var css = {
            ...
            style: [
                '#' + elementId + ' {transition:all 0.4s ease-in-out;position:fixed;z-index:999999;bottom:-20px;left:0;right:0;opacity:0;text-align:center;padding:10px;background-color:#781903}',
            ...
            style2: [
                '#' + elementId + ' {line-height:24px;color:#f1f1f1;font-size:12pt;}',
                '#' + elementId + ' .btn {text-transform:uppercase;cursor:pointer;background-color:#f1f1f1;color:#781903;padding:3px 14px;margin-left:10px;}',
                '#' + elementId + ' .btn:hover {background-color:#ffffff;color:#4d78a5;}',
                '#' + elementId + ' a {text-decoration:none;color:#C7DB27}',
            ],
            type: 'text/css',
